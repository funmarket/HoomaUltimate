...
function CalendarIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <path d="M7.5 3.5v4M16.5 3.5v4M4 9h16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
function PinIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M12 21s6.3-5.3 6.3-11A6.3 6.3 0 1 0 5.7 10C5.7 15.7 12 21 12 21Z" stroke="currentColor" strokeWidth="1.7" />
...
function UsersIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <path d="M3.8 19c.45-4 2.2-6 5.2-6s4.75 2 5.2 6M14.1 14.2c2.65.1 4.3 1.7 4.8 4.8" stroke="currentColor" strokeWidth="1.65" strokeLinecap="round" />
    </svg>
  );
}
function BallIcon() {
  return (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <path d="m12 7 3 2.2-1.15 3.55h-3.7L9 9.2 12 7Zm-3 2.2-3.2.1M15 9.2l3.2.1M10.15 12.75l-2.2 3M13.85 12.75l2.2 3M7.95 15.75l.75 3.05M16.05 15.75l-.75 3.05" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
      ...
      <section className="play-event-card">
        ...
        {isWatch ? (
          <div className="play-event-card__facts">
            ...
            <div>
              <span>Status</span>
              <strong>{event.venueAuthority === "OFFICIAL_VENUE" ? "Official venue" : "Suggested by community"}</strong>
            </div>
          </div>
        ) : (
          <div className="play-event-card__facts">
        ...
        <div className="play-event-card__management-actions">
          {isWatch && event.place ? (
            <a className="play-event-primary-action" href={`/places/${event.place.id}?eventId=${encodeURIComponent(event.id)}`}>
              View Place
            </a>
          ) : null}
          {isWatch && canManage ? (
