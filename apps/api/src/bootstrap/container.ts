...
import { AthletesContentAuthorization } from "../modules/athletes/application/athletes-content-authorizer.js";
...
export function createContainer(config: ApiConfig, overrides: ContainerOverrides = {}) {
  ...
  const athletesContentAuthorizer = new AthletesContentAuthorization(athletesRepository);
