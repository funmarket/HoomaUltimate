...
- Branch: `ride/arch-ride-001-error-boundary`; follow-up guard-hardening branch `ride/arch-ride-001-guard-hardening`.
- PR: #187 (`https://github.com/funmarket/HoomaUltimate/pull/187`) merged the Ride error-boundary correction; guard-hardening follow-up is in progress.
- Merged commit / current foundation HEAD: PR #187 merged as `12ae57cee249f68a53dd3baf9834221ab9ab28d0`; `origin/phase-0-foundation` read-back after merge was `12ae57cee249f68a53dd3baf9834221ab9ab28d0`.
- Current foundation HEAD: `12ae57cee249f68a53dd3baf9834221ab9ab28d0`
...
- Remaining risks: existing non-Ride legacy application services still import `AppError`; this checkpoint intentionally does not migrate unrelated domains. Guard-hardening follow-up still requires PR CI and merge/read-back before foundation can treat `ARCH-RIDE-001` as DONE.
- Safe to begin RIDE-005: NO until guard hardening is merged, read back, and this checkpoint is closed.
