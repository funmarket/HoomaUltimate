...
class FakeIdentityRepository implements IdentityRepository {
  ...
  meRecord: MeRecord | null = {
    id: "user-1",
    presentation: { username: "fan", displayName: "Fan", photoUrl: null, bio: null },
    platformRoles: []
  };

  async createWebIdentity(input: { loginUsername: string; passwordHash: string }): Promise<string> {
    this.credential = {
      userId: "user-1",
  ...
  async recordLoginFailure(userId: string, failedLoginCount: number, lockedUntil: Date | null): Promise<void> {
