...
const packageJson = JSON.parse(
  await readFile(new URL("../packages/frontend/package.json", import.meta.url), "utf8"),
);
const lineupPitch = await readFile(
  new URL("../packages/frontend/src/teams/TeamLineupPitch.tsx", import.meta.url),
  "utf8",
);
const copyScript = await readFile(
  new URL("../packages/frontend/scripts/copy-css.mjs", import.meta.url),
  "utf8",
);
