...
test("IdentityService.me returns Athletes publisher contexts from the account source of truth", async () => {
  const repository = {
...
test("PrismaIdentityRepository.findMe reads active Athletes memberships and projects community identity", async () => {
