...
test("newest refresh merges without discarding loaded older Whistles", () => {
  ...
  const newest = page(
    [item("latest", "2026-09-12T12:00:00.000Z"), item("new", "2026-09-12T13:00:00.000Z")],
    "newest-page-cursor",
  );
...
test("older page advances only the older-history cursor and deduplicates overlaps", () => {
  const current = page(
    [item("middle", "2026-09-12T11:00:00.000Z"), item("latest", "2026-09-12T12:00:00.000Z")],
    "cursor-1",
  );
  const older = page(
    [item("oldest", "2026-09-12T10:00:00.000Z"), item("middle", "2026-09-12T11:00:00.000Z")],
    null,
  );
